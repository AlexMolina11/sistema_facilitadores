@php
    ...
    $puedeVerDashboard = $usuario?->tienePermiso('fac.dashboard.ver');

    $puedeVerConsultores =
        $usuario?->tienePermiso('fac.consultores.ver') ||
        $usuario?->tienePermiso('fac.consultores.gestionar');

    $puedeGestionarCatalogos = $usuario?->tienePermiso('fac.catalogos.gestionar');
@endphp
            ...
            <div id="menuCatalogos"
                ...
                <div class="sidebar-submenu">
                    ...
                    <a href="{{ route('fac.catalogos.sexo.index') }}"
                       class="sidebar-sublink {{ request()->routeIs('fac.catalogos.sexo.*') ? 'active' : '' }}">
                        Sexo
                    </a>
