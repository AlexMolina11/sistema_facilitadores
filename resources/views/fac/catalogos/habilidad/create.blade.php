...
@section('title', 'Nueva habilidad | Facilitadores FEPADE')
@section('page-title', 'Nueva habilidad')
@section('page-subtitle', 'Registrar una nueva habilidad')

@section('content')

<x-ui.page-header
    title="Nueva habilidad"
    subtitle="Completa la información de la habilidad."
/>

<div class="fepade-card">

    <form method="POST"
          action="{{ route('fac.catalogos.habilidad.store') }}">
                ...
                >
                    ...
                    @foreach($tiposHabilidad as $tipoHabilidad)
                        <option
                            ...
                            {{ old('id_tipo_habilidad') == $tipoHabilidad->id_tipo_habilidad ? 'selected' : '' }}
                        >
