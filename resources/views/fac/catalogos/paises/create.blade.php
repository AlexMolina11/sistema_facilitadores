...
@section('page-subtitle', 'Registrar un nuevo país en el catálogo')

@section('content')

<x-ui.page-header title="Nuevo país" subtitle="Completa la información del país." />

<x-ui.page-card title="Datos del país" subtitle="Registra la información principal del país.">
