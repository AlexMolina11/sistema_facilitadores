...
<x-ui.page-header
    title="Editar tipo de atestado"
    subtitle="Actualiza la información del tipo de atestado seleccionado."
/>

<div class="fepade-card">

    <form method="POST"
          action="{{ route('fac.catalogos.tipo-atestado.update', $tipoAtestado) }}">
        ...
        <div class="row g-4">
                ...
                >
                    ...
                    @foreach($tiposFormacion as $tipoFormacion)
                        <option
                            ...
                            {{ old('id_tipo_formacion', $tipoAtestado->id_tipo_formacion) == $tipoFormacion->id_tipo_formacion ? 'selected' : '' }}
                        >
            ...
            <div class="col-md-5">
                ...
                <input
                    type="text"
                    name="nombre"
                    value="{{ old('nombre', $tipoAtestado->nombre) }}"
            ...
            <div class="col-md-3">
                ...
                <div class="form-check form-switch mt-2">
                    ...
                    <input
                        ...
                        value="1"
                        id="activo"
                        {{ old('activo', $tipoAtestado->activo) ? 'checked' : '' }}
                    >
