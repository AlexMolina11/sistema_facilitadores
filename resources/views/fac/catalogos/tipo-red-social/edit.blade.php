...
<x-ui.page-header
    title="Editar tipo de red social"
    subtitle="Actualiza la información del tipo de red social seleccionado."
/>

<div class="fepade-card">

    <form method="POST"
          action="{{ route('fac.catalogos.tipo-red-social.update', $tipoRedSocial) }}">
            ...
            <div class="col-md-3">
                ...
                <div class="form-check form-switch mt-2">
                    ...
                    <input
                        ...
                        value="1"
                        id="activo"
                        {{ old('activo', $tipoRedSocial->activo) ? 'checked' : '' }}
                    >
