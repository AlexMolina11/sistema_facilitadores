...
<x-ui.page-header
    title="Editar tipo de formación"
    subtitle="Actualiza la información del tipo de formación seleccionado."
/>

<div class="fepade-card">

    <form method="POST"
          action="{{ route('fac.catalogos.tipo-formacion.update', $tipoFormacion) }}">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-8">
                ...
                <input
                    type="text"
                    name="nombre"
                    value="{{ old('nombre', $tipoFormacion->nombre) }}"
            ...
            <div class="col-md-4">
                ...
                <div class="form-check form-switch mt-2">
                    ...
                    <input
                        ...
                        value="1"
                        id="activo"
                        {{ old('activo', $tipoFormacion->activo) ? 'checked' : '' }}
                    >
