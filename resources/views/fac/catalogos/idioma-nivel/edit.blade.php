...
<div class="fepade-card">
    ...
    <form method="POST" action="{{ route('fac.catalogos.idioma-nivel.update', $idioma_nivel) }}">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-8">
                ...
                <input
                    type="text"
                    name="nombre"
                    value="{{ old('nombre', $idioma_nivel->nombre) }}"
            ...
            <div class="col-md-4">
                ...
                <div class="form-check form-switch mt-2">
                    ...
                    <input
                        ...
                        value="1"
                        id="activo"
                        {{ old('activo', $idioma_nivel->activo) ? 'checked' : '' }}
                    >
        ...
        <div class="d-flex justify-content-end gap-2">
            ...
            <a href="{{ route('fac.catalogos.idioma-nivel.index') }}" class="btn btn-outline-secondary">
                Cancelar
            </a>
