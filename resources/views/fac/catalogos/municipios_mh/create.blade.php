...
<x-ui.page-card title="Datos del municipio MH" subtitle="Registra el departamento, nombre, código MH y estado del municipio.">
            ...
            <div class="col-md-5">
                ...
                >
                    ...
                    @foreach($departamentos as $departamento)
                        <option value="{{ $departamento->id_departamento }}" @selected(old('id_departamento') == $departamento->id_departamento)>
