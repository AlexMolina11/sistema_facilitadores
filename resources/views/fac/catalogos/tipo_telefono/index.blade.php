        ...
        <table class="table align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="{{ route('fac.catalogos.tipo_telefono.edit', $tipo->id_tipo_telefono) }}"
                           class="btn btn-sm btn-outline-secondary">
                            Editar
                        </a>
                        <form
                            action="{{ route('fac.catalogos.tipo_telefono.destroy', $tipo->id_tipo_telefono) }}"
                            method="POST"
                            class="d-inline"
                            onsubmit="return confirm('¿Deseas desactivar este tipo de teléfono?')"
                        >
                            @csrf
                            @method('DELETE')
                ...
                <tr>
                    <td colspan="3" class="text-center text-muted py-4">
                        No hay tipos de teléfono registrados.
                    </td>
                </tr>
                @endforelse
            </tbody>
