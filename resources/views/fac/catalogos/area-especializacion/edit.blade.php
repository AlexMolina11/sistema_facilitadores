...
<x-ui.page-header 
    title="Editar área de especialización" 
    subtitle="Actualiza los datos del área seleccionada."
/>

<x-ui.page-card 
    title="Datos del área" 
    subtitle="Modifica la información registrada para esta área de especialización."
>
        ...
        <div class="row g-4">
            <div class="col-md-8">
                ...
                <input 
                    type="text" 
                    name="nombre" 
                    value="{{ old('nombre', $areaEspecializacion->nombre) }}" 
            ...
            <div class="col-md-4">
                ...
                <div class="form-check form-switch mt-2">
                    <input 
                        ...
                        value="1" 
                        id="activo" 
                        {{ old('activo', $areaEspecializacion->activo) ? 'checked' : '' }}
                    >
            ...
            <div class="col-12">
                ...
                <textarea 
                    ...
                    rows="3"
                >{{ old('descripcion', $areaEspecializacion->descripcion) }}</textarea>
