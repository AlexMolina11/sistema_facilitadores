...
class BusquedaAvanzadaController extends Controller
{
    ...
    public function index(BuscarConsultoresRequest $request)
    {
        ...
        return view('fac.consultores.busqueda-avanzada.index', [
            ...
            'areasEspecializacion' => AreaEspecializacion::where('activo', true)->orderBy('nombre')->get(),
            'habilidadesTecnicas' => HabilidadTecnica::with('areaEspecializacion')->where('activo', true)->orderBy('nombre')->get(),
