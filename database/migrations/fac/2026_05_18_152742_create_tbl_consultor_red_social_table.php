...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_consultor_red_social', function (Blueprint $table) {
            $table->increments('id_red');
            $table->unsignedInteger('id_consultor');
            $table->unsignedInteger('id_tipo_red_social');
            ...
            $table->foreign('id_tipo_red_social')->references('id_tipo_red_social')->on('tbl_tipo_red_social');
    ...
    {
        Schema::dropIfExists('tbl_consultor_red_social');
    }
};