...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_consultor_habilidad_capacitacion', function (Blueprint $table) {
            $table->increments('id_habilidad_capacitacion');

            $table->unsignedInteger('id_consultor');
            $table->unsignedInteger('id_habilidad');
            $table->unsignedInteger('id_capacitacion_fepade');
            ...
            $table->foreign('id_capacitacion_fepade', 'fk_hab_cap_capacitacion')->references('id_capacitacion_fepade')->on('tbl_consultor_capacitacion_fepade')->onDelete('cascade');
            ...
            $table->unique(['id_consultor', 'id_habilidad', 'id_capacitacion_fepade'], 'uq_consultor_habilidad_capacitacion');
            $table->index(['id_habilidad', 'activo'], 'idx_habilidad_capacitacion_activo');
        });
    }
