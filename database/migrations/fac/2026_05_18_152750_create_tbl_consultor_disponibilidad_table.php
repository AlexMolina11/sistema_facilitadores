...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_consultor_disponibilidad', function (Blueprint $table) {
            $table->increments('id_consultor_disponibilidad');
            $table->unsignedInteger('id_consultor');
            $table->unsignedInteger('id_tipo_disponibilidad');
            ...
            $table->foreign('id_tipo_disponibilidad')->references('id_tipo_disponibilidad')->on('tbl_tipo_disponibilidad');
            ...
            $table->unique(['id_consultor', 'id_tipo_disponibilidad'], 'uq_consultor_disponibilidad');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('tbl_consultor_disponibilidad');
    }
};